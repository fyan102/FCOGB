...
def start_experiments():
    ...
    all_experiments(search_methods=['exhaustive'], objectives=['gpe'], weight_updates=['boosting', 'fc'])
                        ...
                        try:
                            res['titanic' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('titanic', '../datasets/titanic/train.csv',
                                                 ...
                                                 repeat=1, regs=[0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], search=s,
                                                 obj=obj, weight_update=weight_upd, weight_update_method=upd,
                        ...
                        try:
                            res['tic_tac_toe' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('tic-tac-toe', '../datasets/tic_tac_toe/tic_tac_toe.csv',
                                                 ...
                                                 loss='logistic', repeat=5, max_rule_num=30, col=col)
                        except Exception as e:
                            print("Error 1", e)
                            ...
                            res['boston' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('boston', '../datasets/boston/boston_house_prices.csv',
                                                 ...
                                                 [float, float, float, float, float, float, float, int, int, float,
                                                  float,
                                                  float],
                                                 'MEDV', regs=[0, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], search=s,
                                                 obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                                 target_type=float, repeat=5, max_rule_num=30, col=col)
                        except Exception as e:
                            print("Error 1", e)
                    ...
                    for col in [6]:  #
                        res['load_wine' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                            evaluate_loaded_data('load_wine', load_wine,
                                                 ...
                                                 repeat=5, regs=[0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], search=s,
                        ...
                        try:
                            res['ships' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_poisson('ships', '../datasets/count_data2/ships.csv',
                                                 ...
                                                 'damage',
                                                 target_type=int, loss='poisson', repeat=5, max_rule_num=30,
                                                 obj=obj, weight_update=weight_upd, weight_update_method=upd, search=s,
                                                 regs=[0, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], col=col)
                        except Exception as e:
                            print("Error 1", e)
                        try:
                            res['smoking' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_poisson('smoking', '../datasets/count_data2/smoking.csv',
                                                 ['age', 'smoke'], [int, int],
                                                 'dead_per_100',
                                                 target_type=float, loss='poisson', repeat=5, max_rule_num=30,
                                                 obj=obj, weight_update=weight_upd, weight_update_method=upd, search=s,
                                                 regs=[0, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], col=col)
                        except Exception as e:
                            print("Error 1", e)
                        try:
                            res['covid_vic' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_poisson('covid_vic',
                                                 ...
                                                 'new', target_type=int,
                                                 loss='poisson', repeat=5, max_rule_num=30,
                                                 obj=obj, weight_update=weight_upd, weight_update_method=upd, search=s,
                                                 regs=[0, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], col=col)
                        except Exception as e:
                            print("Error 1", e)
                        ...
                        try:
                            res['liver' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('liver', '../datasets/liver/liver.csv',
                                                 ...
                                                 regs=[0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10], search=s, loss='logistic',
                                                 obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                                 repeat=2, max_rule_num=30, col=col)
                        except Exception as e:
                            print("Error 1", e)
                    for col in [5]:
                        try:
                                ...
                                evaluate_dataset('adult', '../datasets/adult/adult.csv',
                                                 ...
                                                 feature_map={
                                                     ...
                                                     'relationship': {'Wife': 0, 'Own-child': 1, 'Husband': 2,
                                                                      ...
                                                                      'Unmarried': 5},
                                                     'race': {'White': 0, 'Asian-Pac-Islander': 1,
                    ...
                    for col in [5]:
                        try:
                            res['who_life_expectancy' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('who_life_expectancy',
                                                 '../datasets/who_life_expectancy/Life Expectancy Data.csv',
                                                 ...
                                                 [int, str, int, int, float, float, int, int, float, int, int, float,
                                                  int, float,
                    ...
                    for col in [3]:
                        try:
                            res['suicide_rates_cleaned' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('suicide_rates_cleaned',
                                                 '../datasets/suicide_rates_cleaned/master.csv',
                                                 ['year', 'sex', 'age', 'population', 'gdp_for_year ($)',
                                                  'gdp_per_capita ($)',
                                                  'generation'],
