...
def start_experiments_time():
    # all_experiments(search_methods=['exhaustive'], objectives=['orth_slow'], weight_updates=['fc'])
    all_experiments(search_methods=['exhaustive'], objectives=['orth'], weight_updates=['fc'])
    ...
    all_experiments(search_methods=['exhaustive'], objectives=['gpe'], weight_updates=['boosting'])
                    ...
                    for col in [20]:
                        res['gdp' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                            evaluate_dataset('gdp', '../datasets/gdp_vs_satisfaction/GDP_vs_Satisfaction.csv',
                                             ...
                                             repeat=5, max_rule_num=25, search=s,
                                             regs=[0],
                                             col=col)
                    for col in [10]:
                        try:
                        ...
                        try:
                            res['wage' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('wage', '../datasets/wages_demographics/wages.csv',
                                         ...
                                         regs=[0], search=s,
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                         repeat=5, max_rule_num=25, col=col)
                        except Exception as e:
                            print("Error 1", e)
                        try:
                        ...
                        try:
                            res['breast' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_loaded_data('breast_cancer', load_breast_cancer,
                                         repeat=1, regs=[0.1], loss='logistic',feature_map={'target': {0: -1, 1: 1}},
                        ...
                        try:
                            res['tic_tac_toe' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('tic-tac-toe', '../datasets/tic_tac_toe/tic_tac_toe.csv',
                                         ...
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                         regs=[0.1], search=s,
                                         loss='logistic', repeat=5, max_rule_num=25, col=col)
                        except Exception as e:
                            print("Error 1", e)
                        ...
                        try:
                            res['boston' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('boston', '../datasets/boston/boston_house_prices.csv',
                                         ...
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                         target_type=float, repeat=5, max_rule_num=25, col=col)
                        except Exception as e:
                            print("Error 1", e)
                        ...
                        try:
                            res['ships' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_poisson('ships', '../datasets/count_data2/ships.csv',
                                         ...
                                         'damage',
                                         target_type=int, loss='poisson', repeat=5, max_rule_num=25,
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd, search=s,
                                         regs=[0], col=col)
                        except Exception as e:
                            print("Error 1", e)
                        try:
                            res['smoking' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_poisson('smoking', '../datasets/count_data2/smoking.csv',
                                         ['age', 'smoke'], [int, int],
                                         'dead_per_100',
                                         target_type=float, loss='poisson', repeat=5, max_rule_num=25,
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd, search=s,
                                         regs=[0], col=col)
                        except Exception as e:
                            print("Error 1", e)
                        try:
                            res['covid_vic' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_poisson('covid_vic',
                                         ...
                                         'new', target_type=int,
                                         loss='poisson', repeat=5, max_rule_num=25,
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd, search=s,
                                         regs=[0], col=col)
                        except Exception as e:
                            print("Error 1", e)
                        ...
                        try:
                            res['liver' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('liver', '../datasets/liver/liver.csv',
                                         ...
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                         repeat=2, max_rule_num=25, col=col)
                        except Exception as e:
                            print("Error 1", e)
                    for col in [5]:
                        try:
                            res['magic' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('magic', '../datasets/magic/magic04.csv',
                                         ...
                                         regs=[0.1], search=s,
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                         repeat=1, max_rule_num=25, col=col)
                        except Exception as e:
                            print("Error 1", e)
                    for col in [5]:
                        try:
                        ...
                        try:
                            res['telco_churn' + '_' + obj + '_' + weight_upd + '_' + upd] = \
                                evaluate_dataset('telco_churn',
                                         ...
                                         obj=obj, weight_update=weight_upd, weight_update_method=upd,
                                         repeat=1, max_rule_num=25, loss='logistic', col=col)
                        except Exception as e:
                            print("Error 1", e)
                print(res)
